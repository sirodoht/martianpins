"""
Django settings for martianpins project.
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "martianpins.com"]
...
DEFAULT_FROM_EMAIL = "martian@sirodoht.com"
